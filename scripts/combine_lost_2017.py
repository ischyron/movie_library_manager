...
def main(argv=None) -> int:
    ap = argparse.ArgumentParser(description="Combine lost-movie CSVs into a single file with unified header.")
    ap.add_argument("--dir", default="data/lost-2017", type=Path, help="Directory containing CSVs to combine")
    ap.add_argument("--glob", default="*.csv", help="Glob pattern for CSVs")
    ap.add_argument("--out", default="data/data_loss_2017.csv", type=Path, help="Output combined CSV path")
